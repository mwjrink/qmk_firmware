...
# Enables Link Time Optimization (LTO) when compiling the keyboard. This makes the process take 
# longer, but can significantly reduce the compiled size (and since the firmware is small, the 
