...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_KP_4,    KC_KP_5,     KC_KP_6,        KC_CAPS,   KC_A,    KC_S,    KC_D,    KC_F,  KC_G,   KC_H,   KC_J,  KC_K,    KC_L,    KC_SCLN, KC_QUOT,   KC_ENT,  KC_NO,   KC_PGUP, 
    ...
    KC_HOME,    KC_P0,       KC_END,         KC_LCTL,   KC_LGUI, KC_LALT, KC_UNDS, KC_NO, KC_SPC, KC_SPC, KC_NO, KC_UNDS, KC_RALT, MO(1),   KC_RCTL,   KC_LEFT, KC_DOWN, KC_RGHT),
